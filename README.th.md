...
มีเสียงกิจกรรมภาษาไทยให้เลือกเปิดได้: event ใหม่ทุกตัวมีเสียงล้ำอนาคตสั้น ๆ เหตุการณ์สำคัญมีคำพูดสั้น ๆ
และภาพ pulse ตามเสียง
...
| **เบราว์เซอร์** | เบราว์เซอร์สมัยใหม่ตัวไหนก็ใช้ได้ เสียงกิจกรรมใช้ Web Audio + Web Speech (เสียงไทยจริงขึ้นกับเบราว์เซอร์/ระบบปฏิบัติการ) ส่วนมุมมอง 3D ต้องมี WebGL เพิ่มด้วย |
...
ทั้งสองหน้ามีปุ่ม `เสียง AI: เปิด / ปิด` ค่าเริ่มต้นคือปิด และจำเพียงตัวเลือกนี้ไว้ใน browser storage
เมื่อคลิกเปิดแล้ว event ใหม่ทุกตัวจะมี electronic cue ส่วนการคิด การใช้ tool การรอ sub-agent error และงานจบ
จะมีคำพูดภาษาไทยสั้น ๆ ถ้า event มารัว cue ยังดังครบ แต่คำพูดซ้ำจะถูกรวบเพื่อไม่ให้ตามหลังงานจริงนาน
snapshot แรกเป็น baseline แบบเงียบเสมอ จึงไม่อ่านประวัติ transcript เก่าตอนเปิดหรือรีเฟรชหน้า

> ⚠️ มีสองเรื่องที่ควรรู้ไว้: `--open` จะเปิดมุมมอง **classic** เสมอ และมุมมอง classic เอง**ไม่มีลิงก์**
> ไปหามุมมอง 3D เลย ต้องพิมพ์ `/brain.html` เข้าไปเอง ส่วนมุมมอง 3D มีลิงก์ `← หน้าคลาสสิก` อยู่ที่แถบควบคุม
> มุมขวาล่างให้
