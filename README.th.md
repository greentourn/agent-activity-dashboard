...
| **เบราว์เซอร์** | เบราว์เซอร์สมัยใหม่บน Windows, macOS หรือ Linux เสียงเอฟเฟกต์ใช้ Web Audio ส่วนเสียงพูดเลือก voice `th-*` ที่ติดตั้งอยู่ในเบราว์เซอร์/ระบบปฏิบัติการ ถ้าไม่มีเสียงไทยจะถอยไปใช้เอฟเฟกต์อย่างปลอดภัย มุมมอง 3D ต้องมี WebGL เพิ่มด้วย |
...
ในเครื่อง และเสียงพูดใช้ voice ภาษาไทยที่ติดตั้งอยู่ในเบราว์เซอร์/ระบบปฏิบัติการ ฟีเจอร์เสียงจึงไม่ส่งข้อความ
หรือข้อมูลกิจกรรมออกทางเครือข่าย ระบบนี้ไม่ได้ผูกกับ Windows—บน macOS และระบบเดสก์ท็อปที่รองรับก็ใช้
เส้นทางเดียวกัน ถ้าไม่มี voice ภาษาไทย เอฟเฟกต์ยังทำงานต่อได้โดยไม่เกิด error
